...
#Release an update using the "release-react" command: -- codepush for app center iOS Staging
appcenter codepush release-react -a Innova-Zones/InnovaZones-iOS-IZ-Main -d Staging