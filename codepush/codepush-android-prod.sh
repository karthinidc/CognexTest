...
#Release an update using the "release-react" command: -- codepush for app center Android Production
appcenter codepush release-react -a Innova-Zones/InnovaZones-Android-IZ-Main -d Production