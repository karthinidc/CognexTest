...
#Change isProduction to true for app center Production
...
#Release an update using the "release-react" command: -- codepush for app center iOS Is_Beta_Testing
appcenter codepush release-react -a Innova-Zones/InnovaZones-iOS-IZ-Main -d Is_Beta_Testing